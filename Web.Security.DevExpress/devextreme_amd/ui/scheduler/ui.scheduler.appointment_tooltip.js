...
var appointmentTooltip = {
    ...
    _tooltipContent: function(appointmentData, singleAppointmentData, $appointment) {
        ...
        var $title = $("<div>").text(text).addClass(APPOINTMENT_TOOLTIP_TITLE_CLASS).appendTo($tooltip);
        ...
        "top" === this.instance.option("_appointmentTooltipButtonsPosition") ? $buttons.prependTo($tooltip) : $buttons.appendTo($tooltip);
