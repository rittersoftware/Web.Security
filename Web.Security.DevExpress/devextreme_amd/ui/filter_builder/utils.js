...
function convertToInnerStructure(value, customOperations) {
    ...
    if (isNegationGroup(value)) {
        return ["!", isCondition(value[1]) ? [convertToInnerCondition(value[1], customOperations), AND_GROUP_OPERATION] : convertToInnerGroup(value[1], customOperations)]
    }
...
function getCurrentLookupValueText(field, value, handler) {
    ...
    var dataSource = new _data_source.DataSource(field.lookup.dataSource);
