        ...
        controllers: {
            ...
            editorFactory: {
                _showRevertButton: function($container, $targetElement) {
                    ...
                    var $tooltipElement = $("<div>").addClass(this.addWidgetPrefix(REVERT_TOOLTIP_CLASS)).appendTo($container);
                    var tooltipOptions = {
                        animation: null,
                        visible: true,
                ...
                _showValidationMessage: function($cell, message, alignment, revertTooltip) {
                    ...
                    var $overlayElement = $("<div>").addClass(INVALID_MESSAGE_CLASS).addClass(INVALID_MESSAGE_ALWAYS_CLASS).addClass(this.addWidgetPrefix(WIDGET_INVALID_MESSAGE_CLASS)).text(message).appendTo($cell);
                    var overlayOptions = {
                        ...
                        onPositioned: function(e) {
                            if (!needRepaint) {
                                needRepaint = _this2._rowsView.updateFreeSpaceRowHeight();
                                if (needRepaint) {
                                    e.component.repaint()
                                }
                            }
